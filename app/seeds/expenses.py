...
def seed_expenses():
    expenses = [
        Expense(created_by=1, created_at=datetime(2023, 1, 1, 10, 0), updated_at=datetime(2023, 2, 1, 10, 0), total_amount=10000, description='Dinner with Mayu', status='pending'),
