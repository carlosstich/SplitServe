...
def seed_user_expenses():
    user_expenses = [
        UserExpense(user_id=1, expense_id=1, paid_amount=5000, original_debt_amount=10000, is_settled=False, created_at=datetime(2023, 1, 1, 12, 0), updated_at=datetime(2023, 1, 1, 12, 0)),
        UserExpense(user_id=2, expense_id=1, paid_amount=5000, original_debt_amount=10000, is_settled=False, created_at=datetime(2023, 2, 16, 10, 30), updated_at=datetime(2023, 2, 16, 10, 30)),
